  ...
  void getCurrentLocation() async {
    ...
    Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
      ...
      setState(() {
        ...
        CacheHelper.saveData(key: MyCacheMy.latitude, value: position.latitude);
        CacheHelper.saveData(
            key: MyCacheMy.longitude, value: position.longitude);
      });
      sleep(const Duration(seconds: 4));
      CacheHelper.saveData(key: MyCacheMy.check, value: true);
