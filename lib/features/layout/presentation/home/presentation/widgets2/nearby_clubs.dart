...
class NearbyClubs extends StatefulWidget {
  const NearbyClubs({super.key});

  @override
  State<NearbyClubs> createState() => _NearbyClubsState();
}

class _NearbyClubsState extends State<NearbyClubs> {
  @override
  void initState() {
    print('********************');
    context.read<HomeCubit>().getNearbyClubs();
    print('********************');
    super.initState();
  }
